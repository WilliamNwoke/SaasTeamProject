...
var CommentModel = /** @class */ (function () {
    ...
    CommentModel.prototype.addComment = function (response, commentData) {
        return __awaiter(this, void 0, void 0, function () {
            var commentMod;
            return __generator(this, function (_a) {
                commentMod = new this.model(commentData);
                return [2 /*return*/, commentMod.save(function (err, comment) {
                        if (err) {
